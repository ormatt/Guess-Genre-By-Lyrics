...
from constants import NEGATIVE_WORDS_PATH
from utils.feat_exts_aux import extract_set_words_ratio, read_lines_into_set

NEGATIVE_WORDS_SET = read_lines_into_set(NEGATIVE_WORDS_PATH)
...
class Worker(BaseFeatExt):
    ...
    @staticmethod
    def extract(text):
        return extract_set_words_ratio(text, NEGATIVE_WORDS_SET)
